...
void login_auth_failed( struct login_session_data *sd, int result ) {
	...
	if ( login_config.log_login ) {
		...
		switch( result ) {
			...
			case   3:
				error = "Rejeitado pelo servidor.";
				break; // 3 = Rejected from Server

			case   4:
				error = "Bloqueado pelo GM.";
				break; // 4 = You have been blocked by the GM Team

			case   5:
				error = "Jogo não atualizado.";
			...
			case  12:
				error = "Trabalhando no Banco de Dados";
				break; // 12 = MSI_REFUSE_TEMP_BAN_FOR_DBWORK

			case  13:
				error = "Bloqueio próprio";
				break; // 13 = MSI_REFUSE_SELF_LOCK

			case  14:
				error = "Grupo não permitido";
			...
			case  16:
				error = "Jogo sofreu modificações.";
				break; // 16 = Hash de verificação falhou
